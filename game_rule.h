...
* pDeadEnemyCount,接受C同学传过来的结构体指针，包含各等级敌人死亡数量
* return：无
*/
...
* 
**/
void GetGameScoreData(int* pCurrentScore, int* pHighestScore, int* pCurrentLevel);//方便C同学调用，获取当前游戏积分数据
...
/**
// * @brief : 读取并更新历史最高分文件
// * @details : 读取存储历史最高分的文件内容，与当前游戏最高分进行比较，
//    若当前最高分高于文件记录，则更新文件内容为当前最高分
// * @param : 无
//*历史最高分文件名=历史最高分
*/
